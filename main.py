...
#-----------------------------------------------------------------------------------------
orbital_elements = [[0] * 7 for _ in range(Num_observation)]  
for i in range(Num_observation - 1):
    for j in range(2):
        ...
        # 계산된 궤도 요소 출력
        print(
            f"계산된 {i*2+j+1}차 궤도요소 : [{orbital_elements[i+j][0]} km, {orbital_elements[i+j][1]} # "
            f"{orbital_elements[i+j][2]} rad, {orbital_elements[i+j][3]} rad, {orbital_elements[i+j][4]} rad, "
            f"{orbital_elements[i+j][5]} rad, {orbital_elements[i+j][6]} JD]"
        )
